    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/hq/**").hasAnyRole("HQ", "SUPER")
                        .requestMatchers(HttpMethod.GET, "/api/patient/**").hasAnyRole("PATIENT", "OFFICE", "OFFICE_ADMIN", "HQ", "SUPER")
                        .requestMatchers("/api/office-admin/**").hasAnyRole("OFFICE_ADMIN", "HQ", "SUPER")
                        .requestMatchers("/api/office/**").hasAnyRole("OFFICE", "OFFICE_ADMIN", "HQ", "SUPER")
